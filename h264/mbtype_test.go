...
func TestMbPartPredMode(t *testing.T) {
	tests := []struct {
		...
		26: {"I", 25, nil, naMbPartPredMode, nil},
		...
		31: {"SP", 3, nil, naMbPartPredMode, nil},
		32: {"SP", 4, nil, naMbPartPredMode, nil},
		// TODO: work out what to do with inferred case.

		// Table 7-14 (B-slices).
		33: {"I", 0, nil, direct, nil},
		34: {"I", 1, nil, predL0, nil},
		35: {"I", 2, nil, predL1, nil},
		36: {"I", 3, nil, biPred, nil},
		37: {"I", 4, nil, predL0, nil},
		38: {"I", 5, nil, predL0, nil},
		39: {"I", 6, nil, predL1, nil},
		40: {"I", 7, nil, predL1, nil},
		41: {"I", 8, nil, predL0, nil},
		42: {"I", 9, nil, predL0, nil},
		43: {"I", 10, nil, predL1, nil},
		44: {"I", 11, nil, predL1, nil},
		45: {"I", 12, nil, predL0, nil},
		46: {"I", 13, nil, predL0, nil},
		47: {"I", 14, nil, predL1, nil},
		48: {"I", 15, nil, predL1, nil},
		49: {"I", 16, nil, biPred, nil},
		50: {"I", 17, nil, biPred, nil},
		51: {"I", 18, nil, biPred, nil},
		52: {"I", 19, nil, biPred, nil},
		53: {"I", 20, nil, biPred, nil},
		54: {"I", 21, nil, biPred, nil},
		55: {"I", 22, nil, naMbPartPredMode, nil},
